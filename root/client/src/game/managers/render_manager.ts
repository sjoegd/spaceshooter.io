...
import { StateRender, BodyRender, SpriteRender, PlayerStateRender } from "../../../../types/render_types";
...
export class RenderManager {
    ...
    drawState(state: StateRender) {
        ...
        const { health, shield, ammo } = this.playerState
